...
REGIME_CONFIGS = {
    "safe": {
        ...
        "config": {
            ...
            "EM_MIN_VOLUME_USD":      300000,
            "EM_MIN_CHANGE_24H":      2.0,
            "EM_MIN_VOLUME_SURGE":    1.1,
            "EM_MAX_MARKET_CAP":      5000000000,
            "EM_MIN_MARKET_CAP":      0,
            "EM_MAX_RESULTS":         15,
            "EM_NEW_LISTING_DAYS":    45,
            "EM_EXCLUDE_SYMBOLS":     "",
    ...
    "normal": {
        ...
        "config": {
            ...
            "EM_EXCLUDE_SYMBOLS":     "",
            "EMERGING_DIRECT_SCORE":  35.0,
            "EMERGING_MOMENTUM_CHG":  3.0,
            "EMERGING_RISK_MULT":     1.8,
            "EMERGING_MAX_SPREAD":    1.2,
        },
    },
    "aggro": {
        "label": "💎 ALL-IN",
